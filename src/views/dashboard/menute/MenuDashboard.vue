<template>
    <div class="float-start" style="margin-left: 47px; margin-top: 6px;">
        <a>
            <router-link class="btn btn-success" to="/dashboard/menute/create">Krijo</router-link>
        </a>
    </div>
    <div class="m-5">
            ...
            <table class="table">
                ...
                <tbody>
                    <tr v-for="food in this.foods" :key="food._id">
                        ...
                        <td><button class="btn btn-sm btn-success"><router-link class="btn-success"
                                    :to="`/dashboard/foods/edit/${food._id}`">Edit</router-link></button></td>
                        <td><button class="btn btn-sm btn-danger" @click="handleDeleteFood(food._id)">Delete</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
